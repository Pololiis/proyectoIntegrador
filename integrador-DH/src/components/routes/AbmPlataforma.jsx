  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}categorias/nuevo`,
        formData,
        {
          headers: {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h2>Registro de Plataforma</h2>
          <button onClick={onClose}>✖</button>
        </div>
        <Formik
          initialValues={{ nombre: "", descripcion: "", imagen: null }}
          ...
          {({ isSubmitting, setFieldValue, errors, touched, values }) => (
            <Form>
              ...
              <div className="mb-3">
                ...
                <Field
                  className={`form-control ${
                    errors.descripcion && touched.descripcion ? "is-invalid" : touched.descripcion ? "is-valid" : ""
                  }`}
                  type="text"
                  name="descripcion"
              ...
              <div className="mb-3">
                ...
                <input
                  className={`form-control ${
                    errors.imagen && touched.imagen ? "is-invalid" : touched.imagen ? "is-valid" : ""
                  }`}
                  type="file"
                  accept="image/*"
        ...
        {mensaje && (
          <div className={`alert ${mensaje.includes("éxito") ? "alert-success" : "alert-danger"} mt-4`} role="alert">
            {mensaje}
          </div>
        )}
      </div>
